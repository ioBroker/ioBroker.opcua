...
class Options extends Component {
    ...
    renderCert(type) {
        return (
            ...
            >
                <InputLabel>
                    {type === 'public' ? I18n.t('Public certificate') : I18n.t('Private certificate')}
                </InputLabel>
                <Select
                    variant="standard"
                ...
                <TextField
                    ...
                    onChange={e => {
                        ...
                        this.setState({ passwordRepeat }, () =>
                            this.props.onConfigError(
                                passwordRepeat !== this.props.native.basicUserPassword ? this.textPasswordMismatch : '',
                            ),
                        );
                    }}
                />
